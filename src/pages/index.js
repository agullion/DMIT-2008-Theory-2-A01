...
export default function Home() {
  ...
  return (
    <Layout description={profileData.site.description} title={profileData.site.title} seoProfile={profileData.seo}>
        ...
        <Card colSpan='md:col-span-1' rowSpan='md:row-span-1'>
          <div className='relative min-h-[44px] overflow-hidden'>
            <footer className='absolute inset-0 text-xs opacity-100 translate-y-0 transition-all duration-300 ease-out group-hover:-translate-y-3 group-hover:opacity-0 group-focus-within:-translate-y-3 group-focus-within:opacity-0'>
              ...
              <a className='text-red-500' href={profileData.site.footer.frameworkUrl} target='_blank'>
            ...
            >
              ...
              <a href='https://github.com/Ladvace/astro-bento-portfolio' target='_blank' rel='noreferrer' className='font-bold font-italic text-red-500'>
                here
              </a>
            </footer>
          </div>
